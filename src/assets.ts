export const assets = [
    ...
    {url: "./dino/run-1.png", name:"DinoRun1"},
    {url: "./dino/run-2.png", name:"DinoRun2"},
    {url: "./dino/run-3.png", name:"DinoRun3"},
    {url: "./dino/run-4.png", name:"DinoRun4"},
    {url: "./dino/run-5.png", name:"DinoRun5"},
